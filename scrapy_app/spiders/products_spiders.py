...
#             yield scrapy.Request(url=url, callback=self.valid_form, meta={"playwright_valid_form": True })
...
#             yield response.follow(item['url'], self.follow_sub_category, cb_kwargs={'super_category_url': item['url']}, meta={"playwright_wait_loading_product": True})
...
#             yield response.follow(url='https://www.agryco.com/soc-de-cultivateur-reversible-75-x-12-20-ea75/p199142', callback=self.parse_product, meta={"playwright_wait_loading_product": True })
    
#     def parse_product(self, response: HtmlResponse):
#         soup = BeautifulSoup(response.body, 'html.parser')
#         main_content = soup.find('main')
#         formatted_html = main_content.prettify()
